...
// src/app/admin/projects/ProjectList.tsx (or same file)
async function ProjectList() {
  ...
  return (
    <>
      {/* DESKTOP VIEW: The table is only rendered if the screen is md or larger */}
      ...
      {/* MOBILE VIEW: Rendered as a list of divs, NOT inside a table tag */}
...
export default function AdminProjectsPage() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12 space-y-8 md:space-y-12">
      {/* Header & Navigation (Static Shell) */}
      ...
      {/* CRITICAL FIX: This div is the only parent. 
          No <table> shell here to prevent nesting errors. 
      */}
